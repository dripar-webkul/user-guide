...
const selectedVersions = ref(['v2.0.0', 'v2.0.0-beta.1', 'v1.0.0', 'v0.3.0', 'v0.2.0'])
...
const features = [
  ...
  // v2.0.0-beta.1
  { title: 'AI Agent Chat Interface', desc: '23 built-in PIM tools accessible via natural language. Create products, search, bulk edit, generate content, manage categories — all through conversation.', version: 'v2.0.0-beta.1', domains: ['ai', 'productivity'] },
  { title: 'Multi-Platform MagicAI', desc: 'Support for 10+ AI providers (OpenAI, Gemini, Ollama, Groq, and more) with encrypted credential storage and per-feature platform selection.', version: 'v2.0.0-beta.1', domains: ['ai', 'connectivity'] },
  ...
  { title: 'ACL Authorization on All AI Agent Tools', desc: 'Role-based access control enforced on all 23 AI Agent tools and 15 previously unprotected API routes.', version: 'v2.0.0-beta.1', domains: ['governance'] },
